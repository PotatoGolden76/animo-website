            ...
            <div className={classNames("container", styles.container)}>
                ...
                <div className={styles.bioContainer}>
                    <p>
                        ...
                        ș
                        i Masterul în Psihodiagnoza cognitiv
                        ă
                        ș
                        i consiliere
                        psihologică
                        ...
                        Sunt un om fascinat de oameni
                        și
                        cred in potentialul de schimbare al celor care inteleg si isi
                        doresc o viata traita constient, sanatos si echilibrat.
                        Mă descriu ca o persoană
                        blândă
                        , empatică,
                        iar
                        deschiderea mea este
                        una plină de căldură și acceptare ca de la om la om, cu toleranță și
                        respect pentru persoana celulilalt.
                        Menirea mea este
                        să
                        îi
                        ajut
                        pe
                        oameni să își descopere propriile drumuri ghidate de valorile
                        personale
                        și să îi susțin în îndepărtarea obstacolelor car
                        e le
                        apar
                        în cale
                        .
                ...
                <p>
                    Abilitatea de a fi în
                    acord cu sentimentele, gândurile și acțiunile tale te ajută să alegi liber și conștient soluții la
                    situațiile cu care te întâlneșți în viața de zi cu zi.
                    S
                    ănătatea psihică și cea emoțională sunt factori
                    cheie ce
                    determină calitatea vieții
                    .
                    ...
                    multe altele
                    .
                    Putem explora împreună moduri prin care poți avea o viață armonioasă, relații sănătoase și o
                    evoluție continuă ca om.
                    Primul pas este
                    drumul
                    spre
                    conștientizare
                    ...
                    nilor
                    emoționale
                    , hrănirea încrederii în forțele
                    proprii prin în
                    v
                    ățare, dedicare și iubire.
                </p>
                ...
                <section>
                    <ul>
                        <li>
                            Master
                            “
                            Psihodiagnoza cognitivă și consiliere psihologică
                            ”
                            -
                            Uni
                            versitatea Ecologică,
                            Bucuresti
                        </li>
                        <li>
